...
CNN1D & Convolutional & Conv1d stack & 47\,041 & --- & canonical Conv1d \\
TCN & Convolutional & causal dilated TCN & 91\,841 & --- & official TCN adapted \\
DLinear & Linear & decomp.\ linear & 1\,031 & --- & LTSF-Linear adapted \\
Transformer & Attention & encoder attention & 80\,257 & --- & native encoder \\
PatchTST & Attention & patch + CI & 109\,962 & --- & PatchTST adapted \\
iTransformer & Attention & inverted tokens & 137\,473 & --- & iTransformer adapted \\
QLSTM & Q-recurrent & quantum LSTM cell & 37\,853 & simulator & paper-faithful \\
QNN-GRU & Q-recurrent & QNN + GRU & 29\,533 & simulator & paper-faithful \\
TE-Q-Transformer & Proposed & Arrhenius VQC + Transformer & 92\,554 & 4-qubit sim. & this work \\
\bottomrule
\end{tabular*}
\end{table*}
...
$^{\mathrm{a}}$Frozen reference. E05 training time $18.5$\,s is not comparable to the ten trained baselines and is omitted.
\end{minipage}
\end{table*}
...
\end{tabular*}
\vspace{2pt}
$^{\mathrm{s}}$PennyLane \mbox{\texttt{default.qubit}}. $^{\mathrm{b}}$E06 CUDA retraining, not the E05 frozen reference.
\end{table*}
