...
% TODO: Experimental setup content to be added in manuscript revision. Setup material already appears in Methodology and is not duplicated here.

\subsection{Main Benchmark Performance}\label{sec:nasa}
...
\subsection{Qualitative SOH Trajectory Analysis}\label{sec:qualitative-traj}
% TODO: Qualitative trajectory analysis was already merged with cell-wise result analysis in the source manuscript. The combined existing content is placed once in the following subsection to avoid duplication.

\subsection{Cell-wise Generalization Analysis}
...
\subsection{Evidence-based Analysis}\label{sec:discussion}
...
\subsection{External Validation on CALCE}\label{sec:calce}
