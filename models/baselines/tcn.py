...
class CausalDilatedConv1DBlock(nn.Module):
...
# Alias for backward compatibility with existing checkpoints
ChausalDilatedConv1DBlock = CausalDilatedConv1DBlock
...
__all__ = ["TCNModel", "CausalDilatedConv1DBlock", "ChausalDilatedConv1DBlock"]
