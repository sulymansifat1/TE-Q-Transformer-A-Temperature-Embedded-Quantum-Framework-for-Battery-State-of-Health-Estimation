"""QLSTM baseline (gate-level quantum recurrent) adapted for battery SOH seq-to-one regression.

Provenance (paper + author code reference):
- Paper: "Quantum Long Short-Term Memory" (ICASSP 2022)
- Architecture: Gate-level QLSTM where each LSTM gate uses a Variational Quantum Circuit (VQC).
"""
...
__all__ = ["QLSTMSOHModel", "QLSTMConfig"]
